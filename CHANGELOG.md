...
- Add a metric in Prometheus to track the total number of probes running (#1222).

### Fixed

- Handle disabled and enabled probe changes type (#1223).

### Changed

- Bump oclif versions (#1224).
- Update notification package to v1.16.0 (#1228).
